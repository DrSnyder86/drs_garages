...
-- Optional enforcement-impound metadata used by DRS vehicle targeting. This
-- table is DRS-owned and intentionally has no foreign key to player_vehicles so
-- it remains compatible with both id-based and plate-only framework schemas.
